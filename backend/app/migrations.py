...
def run_lightweight_migrations(engine) -> None:
    ...
    ensure_column(engine, "keywords", "secondstreet_condition_ranks", "TEXT DEFAULT ''")
    ensure_column(engine, "keywords", "offmall_condition_ranks", "TEXT DEFAULT ''")
    ensure_column(engine, "keywords", "mandarake_condition_ranks", "TEXT DEFAULT ''")
    ensure_column(engine, "keywords", "surugaya_condition_tags", "TEXT DEFAULT ''")
